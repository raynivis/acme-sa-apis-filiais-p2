...
API_NAME = "Alvorada ACME/SA API"
API_PORT = int(os.getenv('API_PORT', 8003))
DATABASE_NAME = os.getenv('DATABASE_NAME', 'alvorada.db')
...
REPLICAS = load_replicas('alvorada')

replica_manager = ReplicaManager("alvorada", REPLICAS)
